...
<head>
    ...
    <link href="<?=  base_url();?>assets/css/style13.css" rel="stylesheet" />
</head>
<body>
    <!-- Wrapper -->
    <div class="aksa-wrapper" data-layout="vertical" data-layout-style="default" data-menu="light" data-footer="simple">
        <!-- Top Navbar -->
                                        ...
                                        <div class="media">
                                            <div class="media-head me-2">
                                                <div class="avatar avatar-primary avatar-sm avatar-rounded">
                                                    <span class="initial-wrap">MI</span>
                                                </div>
                                            </div>
                                            <div class="media-body">
                                                <div class="dropdown">
                                                    <a href="#" class="d-block dropdown-toggle link-dark fw-medium" data-bs-toggle="dropdown" data-dropdown-animation data-bs-auto-close="inside">Humnafs Admin</a>
                                                </div>
                                                <div class="fs-7">admin@humnafas.org</div>
                                                <a href="#" class="d-block fs-8 link-secondary"><u>Sign Out</u></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="https://milleniance.com/">Help & Support</a>
                                </div>
                            </div>
                        </li>
                    </ul>
