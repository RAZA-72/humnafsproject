...
<div class="border-top py-4">
                  ...
                  <div class="row">
                        ...
                        <tbody id="CartProducts">
                            ...
                            <tr class="cart__row responsive-table__row">
                              <td class="cart__cell--image">
                                <div class="d-flex">
                                  <a href="/collections/all/products/moisture-maker-hydrating-hyaluronic-serum?variant=42425786236985" class="cart__image ">
                                    <img src="<?= base_url(); ?>assets/images/saree-6.jpg" loading="lazy" width="130px" height="100%">
                                  </a>
                                </div>
                              </td>
                              <td class="d-none d-lg-table-cell">
                                <a href="/products/moisture-maker-hydrating-hyaluronic-serum?variant=42425786236985" class="h6 text-body">
                    ...
                    <div class="col-lg-4">
                      ...
                      <div class="row cart__row border-0">
                        ...
                        <div class="col-12">
                          <label for="CartSpecialInstructions" class="mb-1">Special instructions for seller</label>
                          <textarea name="note" id="CartSpecialInstructions" class="cart__note"></textarea>
                        </div>
                        
             <div class="block-coupon col-12 block-coupon-cart">
                            <discount-code><div id="list-coupon" class="pt-2 mb-3 text-left">
                                <div class="card-coupon">
                                  <div class="d-flex flex-column align-items-center">
                                    <div class="mb-4 w-100 text-left">
                                      <label class="mb-1" for="discount-code-input">Already have coupon?</label>
                                      <div class="d-flex w-100 gap-2">
                                        <input class="form-control" type="text" id="discount-code-input" autocomplete="on" value="">
                                        <div>
                                          <span id="apply-discount-btn" class="btn btn-outline-danger">Apply</span>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                          ...
                          <div class="flex align-items-center mt-2">
                           <span class="mr-auto">Total</span>
                            <p class="h4 cart__subtotal text-body mt-0" id="CartSubtotal">₹ <span>18,000</span> + Free Shipping</p>
                          </div>
    ...
    class="btn btn-outline-dark gradient-theme btn-cart-checkout w-100">
    Check Out
</button>
                            <ul id="cart-payment-methods" class="list-inline payment-icons text-center"><li class="list-inline-item">
