                                        ...
                                        <div class="col-lg-5 col-md-7 col-sm-10 mx-auto">
                                            <div class="text-center mb-5">
                                                <a class="navbar-brand me-0" href="index.html">
                                                    <img class="brand-img w-50 d-inline-block" src="<?= base_url('');?>/assets/images/11.png" alt="Humnafas">
                                                </a>
                                            </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row gx-3">
                                                        <div class="form-group col-lg-12">
                                                            ...
                                                            <input class="form-control" name="loginid" placeholder="Enter username or email ID" value="" type="text">
                                                        </div>
                                                        <div class="form-group col-lg-12">
                                                            <div class="form-label-group">
                ...
                <footer class="container-xxl footer">
                    <div class="row">
                        <div class="col-xl-8 text-center">
                            <p class="footer-text pb-0"><span class="copy-text">Humnafs India © 2022 All rights reserved.</span> </p>
                        </div>
                    </div>
                </footer>
            </div>
